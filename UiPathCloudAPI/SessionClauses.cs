...
{
    public class SessionClauses : IClause
    {
        public SessionClauses(int top = -1, SessionFilter filter = null, string select = null, string expand = null, string orderby = null, string skip = null)
        {
            Top = top;
            Filter = filter;
            Select = select;
